...
<body>
<div class="tab">
  <button class="tablinks" onclick="openCity(event, 'ListofEmployees')" id="defaultOpen"> APPRAISAL FORM</button>
  <button class="tablinks" onclick="openCity(event, 'Monitoring')">MEMOS</button>
</div>
